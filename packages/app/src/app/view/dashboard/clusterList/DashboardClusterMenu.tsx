      ...
      items={[
        {
          ...
          confirm: {
            ...
            runMark: actions.start.confirm.run.mark,
            cancelMark: actions.start.confirm.cancel.mark,
            ...actions.start.confirm.mark,
          },
          ...actions.start.mark,
        },
        {
        ...
        },
        {
          ...
          confirm: {
            ...
            runMark: actions.destroy.confirm.run.mark,
            cancelMark: actions.destroy.confirm.cancel.mark,
            ...actions.destroy.confirm.mark,
          },
