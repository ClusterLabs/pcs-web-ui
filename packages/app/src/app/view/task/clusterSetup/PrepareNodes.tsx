import {Alert, AlertActionLink, useWizardContext} from "@patternfly/react-core";
    ...
    <TaskLibStep title="Prepare nodes" reports={allReports}>
          ...
          title={
            {
              ...
              "auth-check-started": "Checking if the nodes are authenticated",
      ...
      {clusterAndNodesCheck === "can-add-cannot" && (
        <Alert
          ...
          actionLinks={
            <>
              <AlertActionLink onClick={goToPrevStep}>Go back</AlertActionLink>
        ...
        >
          You can modify cluster name and/or nodes in the previous step or you
          can try it again if the errors have already become irrelevant.
        </Alert>
      )}
      ...
      {clusterAndNodesCheck === "send-known-hosts-fail" && (
        <Alert
          ...
          title={
            <>
              Sending updated known host to the setup coordinating node failed
            </>
          }
          actionLinks={
