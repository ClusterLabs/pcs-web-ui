...
export const areDataLoaded: Selector<boolean> = (
  state => state.cluster.dataFetchState === fetchStatusSuccess
);

export const getCluster: Selector<ClusterState> = (
  state => state.cluster.clusterState
);
...
export const getSelectedResource = (
  id: string,
): Selector<ResourceTreeItem|undefined> => (
  (state) => {
