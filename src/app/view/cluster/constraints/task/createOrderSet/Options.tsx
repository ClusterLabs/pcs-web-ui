...
import { FormRadios, FormSwitch, FormText, TaskLibStep } from "app/view/share";
...
export const Options: React.FC = () => {
  const {
    updateState,
    state: { id, kind, symmetrical, reports },
  } = useTask();
  return (
            ...
            body: (
              <>
                ...
                <dl>
                  ...
                  <dt>
                    The constraint applies only if both specified resource
                    actions are scheduled in the same transition (that is, in
                    response to the same cluster state). This means that
                    then-action is allowed on the then resource regardless of
                    the state of the first resource, but if both actions happen
                    to be scheduled at the same time, they will be ordered.
                  </dt>
                  <dd>
            ...
            body: (
              <>
                <p>
                  ...
                  opposite action (for example, if B starts after A starts, then
                  B stops before A stops).
                </p>
