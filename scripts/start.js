...
const {localUrlForTerminal, lanUrlForTerminal, lanUrlForConfig} = prepareUrls(
  protocol,
  HOST,
  port,
...
compiler.hooks.done.tap("done", async stats => {
  ...
  console.log(`Browser: ${localUrlForTerminal} or ${lanUrlForTerminal}`);
});
...
const devServer = new WebpackDevServer(
  {
    ...createDevServerConfig(proxyConfig, lanUrlForConfig, publicPath),
    host: HOST,
    port,
  },
  compiler,
